...
export default function Index() {
  ...
  return <div className="min-h-screen bg-background overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-secondary/20 rounded-full blur-3xl animate-float animate-morph" style={{
        animationDelay: "2s"
      }} />
        <div className="absolute top-1/2 left-1/4 w-48 h-48 bg-neon-pink/10 rounded-full blur-3xl animate-float" style={{
        animationDelay: "4s"
      }} />
        ...
        <div className="container mx-auto px-4 py-32 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className={`text-5xl md:text-7xl font-bold mb-6 ${mounted ? 'animate-fade-in-up' : 'opacity-0'}`}>
              ...
              <br />
              <span className="text-foreground inline-block" style={{
              animationDelay: "0.2s"
            }}>
                In Your Browser
              </span>
            ...
            <p className={`text-xl text-muted-foreground max-w-2xl mx-auto mb-10 ${mounted ? 'blur-in' : 'opacity-0'}`} style={{
            animationDelay: "0.3s"
          }}>Real-time face detection, hand tracking, object recognition, pose estimation, OCR, and Attendance System — all powered by TensorFlow.js and MediaPipe. No server required.

          </p>

            {/* CTA Buttons with hover effects */}
            <div className={`flex flex-col sm:flex-row gap-4 justify-center ${mounted ? 'animate-fade-in-up' : 'opacity-0'}`} style={{
            animationDelay: "0.4s"
          }}>
              <Button className="group relative h-14 px-10 text-lg bg-gradient-to-r from-primary to-secondary text-primary-foreground overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-primary/30" asChild>
                <a href="#features">
              ...
              <Button className="group h-14 px-10 text-lg bg-card/50 backdrop-blur-lg border border-border/50 text-foreground transition-all duration-300 hover:bg-card/70 hover:border-primary/50 hover:scale-105" asChild>
            ...
            {/* Scroll indicator */}
            <div className={`mt-16 ${mounted ? 'animate-fade-in' : 'opacity-0'}`} style={{
            animationDelay: "1s"
          }}>
      ...
      <section id="features" className="py-24 relative">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto animate-fade-in-up" style={{
            animationDelay: "0.1s"
          }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {features.map((feature, index) => <FeatureCard key={feature.path} {...feature} index={index} />)}
          </div>
        </div>
      </section>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full border border-border/30 animate-spin-slow opacity-30" style={{
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            return <div key={index} className="group text-center p-6 rounded-2xl bg-card/30 backdrop-blur border border-border/30 opacity-0 animate-fade-in-up hover-lift transition-all duration-300 hover:border-primary/30" style={{
